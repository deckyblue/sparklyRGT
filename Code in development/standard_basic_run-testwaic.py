...
basic_model = """
  ...
  generated quantities {
    vector[ntr] log_lik;
    for (tr in 1:ntr) {
        log_lik[tr] = categorical_logit( beta[currentSubject] * Q );
    }
  } // generated quantities
"""

#O[tr] is the log likelihood 
# log_lik[tr] = categorical_logit_lpmf(y[j] | theta[j], sigma[j])
#compile stan code
...
fit_az.to_netcdf('standard_basic_fit.nc')