...
reverse_basic = stan.build(basic_model, data = model_data, random_seed=1)

#do the sampling
##change names of objects to reflect task, and the sample code
reverse_basic_fit = reverse_basic.sample(num_chains=4)
##change object name and argument
reverse_basic_az = az.from_pystan(reverse_basic_fit)
##change object name and argument
reverse_basic_az.to_netcdf('reverse_basic_fit.nc')