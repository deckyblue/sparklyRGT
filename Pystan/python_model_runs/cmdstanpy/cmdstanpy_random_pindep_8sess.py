...
#do the sampling
fit = model.sample(data = model_data, chains = 4, iter_sampling = 1000, iter_warmup = 1000, 
                   parallel_chains = 4)
...
fit_az.to_netcdf('/scratch/st-caw42-1/stan_output/' + task_name + '_' + model_name +  '_fit_8sess.nc')