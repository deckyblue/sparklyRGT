...
#do the sampling
fit = model.sample(data = model_data, chains = 4, iter_sampling = 2000, iter_warmup = 2000, 
...
fit_az.to_netcdf('/scratch/st-caw42-1/stan_output/' + task_name + '_' + model_name +  '_fit_2000_ad99.nc')