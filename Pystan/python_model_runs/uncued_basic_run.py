...
uncued_basic = stan.build(basic_model, data = model_data, random_seed=1)

#do the sampling
##change names of objects to reflect task, and the sample code
uncued_basic_fit = uncued_basic.sample(num_chains=4)
##change object name and argument
uncued_basic_az = az.from_pystan(uncued_basic_fit)
##change object name and argument
uncued_basic_az.to_netcdf('uncued_basic_fit.nc')